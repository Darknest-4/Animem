        ...
        <input type="text" style="display:none;" type="text" name="save" value="<?= $id;?>" readonly="readonly" form="form1">
          <div class="row">
            <div class="col-12">
              ...
              <a class="btn" target="_blank" href="<?= BASEURL;?><?= $link;?>" style="background-color:#d63384; color:#fff;">View</a>
              ...
              <a class="btn btn-info" href="https://animem.org/datasheet.php?reimage=<?= $myanimelist;?>&id=<?= $id;?>">Re-Image</a>
            </div>
          </div>
          <div class="row">
            <div class="col">
              <div class="table-responsive">
                <table class="table table-striped">
                  <tbody>
                    ...
                    <tr>
                      <td>Cím:</td>
                      <td><input type="text" class="form-control" type="text" name="title" value="<?= $title;?>" form="form1"></td>
                    </tr>
                    <tr>
                      <td>Link:</td>
                      <td>
                        <div class="input-group">
                          <span class="input-group-text">https://animem.org/</span>
                          <input type="text" class="form-control" name="link" value="<?= $link;?>" form="form1">
                          <span class="input-group-text"><a href="https://animem.org/<?= $link;?>" target="_blank">Open</a></span>
                        </div>
                      </td>
                    </tr>
                    <tr>
